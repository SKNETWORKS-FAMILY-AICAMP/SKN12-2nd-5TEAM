...
본 프로젝트는 5인 팀으로 구성된 데이터 분석 프로젝트입니다.  
각 팀원은 다양한 역할을 분담하여 효율적인 협업을 이루었습니다.
...
💬 [허한결]
이번 프로젝트를 하며 단순한 알고리즘 구현을 넘어 실제 사용자에게 보여줄 수 있는 예측 결과를 만들어야 한다는 점에서 많이 고민하고 성장할 수 있었습니다. 개인적으로는 LightGBM, XGBoost, Voting 모델을 비교하고 최적화하는 과정이 가장 인상 깊었고, Streamlit을 활용해 UI까지 구현해보니 전체 흐름이 머릿속에 정리되는 느낌이었습니다. GitHub Desktop을 통한 협업도 처음이었지만 큰 도움이 되었고, 팀원들의 피드백 덕분에 좋은 결과를 낼 수 있었습니다.
